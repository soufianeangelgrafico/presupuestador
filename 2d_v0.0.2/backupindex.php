...
<body style="background:#d6d6d6;margin:0;padding:0; ">
		...
		<div id="parte_superior">
			...
			<div id="menu_planificador">
				...
				<div id="submenu_paso2" style="display:block">
					...
					<div class="divmenu menu-activo" id="menu_plano">
						<h5 class="subtitular-planificador">
							<div class="submenu-header"><b>PASO_2.1</b></div><b> TABIQUES, PUERTAS Y VENTANAS </b><br> <i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso21')"></i>
						</h5>
					</div>

					<div class="divmenu" id="menu_mobiliario">
						<h5 class="subtitular-planificador">
							<div class="submenu-header"><b>PASO_2.2</b></div><b> MOBILIARIO Y ELECTRODOMÉSTICOS</b><br> <i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso22')"></i>
						</h5>
					</div>

					<div class="divmenu" id="menu_instalaciones">
						<h5 class="subtitular-planificador">
							<div class="submenu-header"><b>PASO_2.3</b></div><b>INSTALACIONES</b><br><i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso23')"></i>
						</h5>
					</div>

					<div class="divmenu" id="observaciones">
						<h5 class="subtitular-planificador">
							<div class="submenu-header"><b>PASO_2.4</b></div><b>OBSERVACIONES</b><br><i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso24')"></i>
						</h5>
					</div>
				</div>
						...
						<div id="wallTools" style="display:none;">
							...
							<ul class="list-unstyled">
								<li><button class="btn btn-danger" id="wallTrash"><i class="fa fa-2x fa-trash-o" aria-hidden="true"></i></button>
									<button class="btn btn-info" onclick="fonc_button('select_mode');$('#boxinfo').html('Modo selección');$('#wallTools').hide('300');$('#panel').show('300');"><i class="fa fa-2x fa-backward" aria-hidden="true"></i></button>
								</li>
							</ul>
								...
								?>
									<div class="metros_lineales" <?php if (isset($_GET["id_presupuesto"])) { ?> style="display:block;" <?php } ?>>
										<form class="form_metros" name="<?php echo $arr_result['id_imagen']; ?>" method="POST" action="#">
											<input type="text" name="elemento" style="display:none" value="<?php echo $arr_result['id_imagen']; ?>">
											<input type="range" value="<?php if ($metros_lineales != 0) {
											...
											Metros lineales: <output style="display:inline-block"><?php if ($metros_lineales != 0) {
																										echo $metros_lineales;
																									} else { ?> 1 <?php } ?></output>
				...
				<div id="opciones_equipamiento">
					...
					<div class="child_list">
					 ...
					 grid-template-columns: auto auto; width:calc( 100% - 20px ); margin: 10px;">
							<button onclick="manageStep5Submenu(this,1);" class="equipment_options_btn">
								<img src="CapasCocina/EQUIPAMIENTO/CalderaJunkersCondensacionCerapurZwbc24-2CGn.png" />
	...
	<div id="bloque_estado_actual" style="background: url('<?php echo $png_estado_actual; ?>') #95C11F;">
...
<script>
	...
	function manageStyleInfo(objct) {
		...
		$(objct).parent().nextAll('div .style-info').css({
			top: coords.top + 'px'
		});
		$(objct).parent().nextAll('div .style-info').css({
