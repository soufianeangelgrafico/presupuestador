var editor = {
          ...
          // if (wallInhibation && isObjectsEquals(wall, wallInhibation)) E = false;
            /*for (var k in E) {
              ...
              if (E[k].type == 'start' && E[k].wall.parent == null && angleInter > 20 && angleInter < 160) {
                ...
                var nextWallStart = nextWall.start;
                var nextWallEnd = nextWall.end;
                console.error(nextWallStart + " : " + nextWallEnd);
              }
            }*/
        }
  ...
  makeWall: function (way) {
    if ($("#muro1").length == 0) var ruta = "muro1";
    else if ($("#muro2").length == 0) var ruta = "muro2";
    else if ($("#muro3").length == 0) var ruta = "muro3";
    else if ($("#muro4").length == 0) var ruta = "muro4";
    else if ($("#muro5").length == 0) var ruta = "muro5";
    else if ($("#muro6").length == 0) var ruta = "muro6";
    else if ($("#muro7").length == 0) var ruta = "muro7";
    else if ($("#muro8").length == 0) var ruta = "muro8";
    else if ($("#muro9").length == 0) var ruta = "muro9";
    else if ($("#muro10").length == 0) var ruta = "muro10";
    else if ($("#muro11").length == 0) var ruta = "muro11";
    else if ($("#muro12").length == 0) var ruta = "muro12";
    else if ($("#muro13").length == 0) var ruta = "muro13";
    else if ($("#muro14").length == 0) var ruta = "muro14";
    else if ($("#muro15").length == 0) var ruta = "muro15";
    else if ($("#muro16").length == 0) var ruta = "muro16";
    else if ($("#muro17").length == 0) var ruta = "muro17";
    else if ($("#muro18").length == 0) var ruta = "muro18";
    else if ($("#muro19").length == 0) var ruta = "muro19";
    else if ($("#muro20").length == 0) var ruta = "muro20";
  ...
  roomMaker: function (Rooms) {
    ...
    for (var rr = 0; rr < ROOM.length; rr++) {
      ...
      //De select mode, porque si no, en versión móvil, cuando me muevo por la pantalla, me sigue dibujando muros
        //7mar: 7ytha 7ta nchof ach ghadi ndir liha
    ...
    if (globalArea <= 0) {
      ...
      $("#areaValue").html((globalArea / 3600).toFixed(1));
    }
  },
  ...
  showScaleBox: function () {
    if (ROOM.length > 0) {
      ...
      var width = maxX - minX + 0.8*2;
      var height = maxY - minY + 0.8;

      var labelWidth = Number(((maxX - minX) / meter) + 0.084).toFixed(2);
      var labelHeight = Number(((maxY - minY) / meter) + 0.084).toFixed(2);
