	 ...
	 <div id="opciones_crear_plano" style="display:none;">
		  <div id="panel">
			...
			<div id="informacion_pared">
				...
				<input id="altura_paredes" type="range" value="2" min="2" max="5" step="0.01" oninput="this.nextElementSibling.value = this.value">
...
?>
  ...
  <div style="width: 20vw;height:75vh;position: absolute;right: 0px;top: 75;"><h1 style="background: #95C11F;text-align: center;">ESTADO ACTUAL</h1>
	<iframe src="https://rehubik.com/presupuestador/2d/ver_plano_estado_actual.php?sesion=<?php echo $_COOKIE['random'];?>" style="width: 100%;height: 100%;"></div></iframe>
   </div>
  ...
  <script>
	   ...
	   $("#menu_trabajos").click(function() {
		 ...
		 $(".info_muro").each(function() {
			 ...
			 //Ahora que ha creado todos los muros, debo mirar si algún muro lo había marcado como "Tabique a demoler" (lo sé porque el fill es de color #f08675). Si hay alguno marcado, el elemento de picado desescombro de tabiquería (en trabajos realizados) debe tener marcado por defecto esta pared.
			 $( ".muro" ).each(function() {
