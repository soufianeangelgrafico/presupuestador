...
$("#btnGuardarAnotacion").click(function (e) {
  ...
  if (textToMake != "" && textToMake != "Tu observación") {
	...
	$('#anotaciones_observacion').append('<div>'+$('#labelBox').html()+'</div>');
...
function rib(shift = 20) {
  // return false;  
	...
	//Se ha comentado el ribmaster[1] para no ver las coordenadas internas
  ...
  if (classObj == 'doorWindow') {
    ...
    if (typeObj == 'left-door') {
        construc.push({'path':"M "+(-sizeObj/2)+","+(-thickObj/2)+ 
            ...
            " L "+(sizeObj/2)+","+(thickObj/2)+
            " L "+(-sizeObj/2)+","+(+thickObj/2)+
        " Z", 'fill': "white", 'stroke': "black", 'strokeDashArray': '5,5'});
        ...
        construc.push({'path': "M "+(sizeObj/2-5)+","+(thickObj/2)+
            " L "+(sizeObj/2-5)+","+(sizeObj)+
            " L "+(sizeObj/2-10)+","+(sizeObj)+
            " L "+(sizeObj/2-10)+","+(thickObj/2)
          , 'fill': "black", 'stroke': colorWall, 'strokeDashArray': ''});
      
        construc.push({'path': "M "+(sizeObj/2-10)+","+(sizeObj)+
            "  Q"+(-sizeObj/4)+"," +(sizeObj-10)+","+(-sizeObj/2+5)+","+thickObj/2+","+
            " Z",'fill': "none", 'stroke': colorWall, 'strokeDashArray': ''});
    ...
    if (typeObj == 'double') {
       ...
       //r arch
        construc.push({'path': "M "+(-sizeObj/2+5)+","+(thickObj/2)+
            " L "+(-sizeObj/2+5)+","+(sizeObj/2)+
            " L "+(-sizeObj/2+10)+","+(sizeObj/2)+
            " L "+(-sizeObj/2+10)+","+(thickObj/2)
          , 'fill': "black", 'stroke': colorWall, 'strokeDashArray': ''});
      
        construc.push({'path': "M "+(-sizeObj/2+10)+","+(sizeObj/2)+
            "  Q"+(0)+"," +(sizeObj/2-10)+","+(0)+","+thickObj/2+","+
            " Z",'fill': "none", 'stroke': colorWall, 'strokeDashArray': ''});
        //l arch
          construc.push({'path': "M "+(sizeObj/2-5)+","+(thickObj/2)+
            " L "+(sizeObj/2-5)+","+(sizeObj/2)+
    ...
    if (typeObj == 'staff-door') {
        ...
        construc.push({'path':"M "+(-10)+","+(-2.5)+ 
         ...
         " Z", 'stroke': "black", 'strokeDashArray': 'none'});
     ...
     if (typeObj == 'right-sliding-door') {
         ...
         //center square
         construc.push({'path':"M "+(2.5)+","+(thickObj/2)+ 
        ...
        //black bar
        construc.push({'path':"M "+(sizeObj/4)+","+(thickObj/6)+ 

             " L "+(-sizeObj/4)+","+(thickObj/6)+ 
             " L "+(-sizeObj/4)+","+(-thickObj/6)+ 
             " L "+(sizeObj/4)+","+(-thickObj/6)+ 
             " Z", 'fill': "black", 'stroke': "black", 'strokeDashArray': 'none'}); 
        //dotted top
         construc.push({'path':"M "+(2.5)+","+(thickObj/2)+ 

             " L "+(sizeObj/2)+","+(thickObj/2)+ 
           
             " Z", 'fill': "black", 'stroke': "black", 'strokeDashArray': '5,5'}); 
        //dotted btn
         construc.push({'path':"M "+(2.5)+","+(-thickObj/2)+ 
    ...
    if (typeObj == 'afixed-window') {
        ...
        construc.push({'path':"M "+(-sizeObj/2+5)+","+(thickObj/2)+ 
            " L "+(sizeObj/2-5)+","+(thickObj/2)+
        " Z", 'stroke': "black", 'strokeDashArray': '5,5'});
    ...
    if (typeObj == 'double-sliding-window') {
        ...
        construc.push({'path':"M "+(sizeObj/2-5)+","+(0)+ 
            " L "+(sizeObj/2-5)+","+(-thickObj/4)+ 
            " L "+(0)+","+(-thickObj/4)+
            " L "+(0)+","+(0)+
        " Z", 'fill': "#494646", 'stroke': "#494646", 'strokeDashArray': 'none'});
        ...
        construc.push({'path':"M "+(sizeObj/2-5)+","+(-thickObj/4)+ 
            " L "+(sizeObj/2-5)+","+((-thickObj/4)*2)+ 
            " L "+(0)+","+((-thickObj/4)*2)+
            " L "+(0)+","+(-thickObj/4)+
        " Z", 'fill': "white", 'stroke': "#494646", 'strokeDashArray': 'none'});
