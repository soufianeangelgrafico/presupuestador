...
$(document).on("input", '[name="metros_parcial"]', function () {
    ...
    /* Selecting the form with the name of the first element in the array, then selecting the input
    with the value of the class name of the element that was clicked. */
    /* Seleccionando el formulario con el nombre del primer elemento en el array, luego seleccionando el input
    con el valor del nombre de la clase del elemento que fue pulsado. */

    /*
    Esta línea de código selecciona un elemento de tipo "input" que tenga el valor del atributo "className" 
    del elemento actual como su valor y que esté contenido dentro de un elemento "form" cuyo nombre sea 
    igual al nombre del elemento padre del elemento actual. Luego, se obtiene el valor de este elemento 
    seleccionado y se divide en una matriz utilizando la barra diagonal como separador. El resultado 
    de esta operación se almacena en una variable llamada "valor_anterior".
    */
    var valor_anterior = $(
        "form[name='" + a[0].name + "'] * input[value='" + this.className + "']"
    ).val().split("/");

    /* Changing the value of the input field with the class name of the button that was clicked. */
    /* Cambiar el valor del campo de entrada con el nombre de clase del botón que se ha pulsado. */
    $(
        "form[name='" + a[0].name + "'] * input[value='" + this.className + "']"
    ).val(valor_anterior[0]);

    /* Selecting the form with the name of the first element in the array, then selecting all the
    inputs with the type of checkbox and the value of the class name. Then it is setting the
    attribute of checked to true. */
    /* Seleccionando el formulario con el nombre del primer elemento del array, luego seleccionando 
    todas las inputs con el tipo de checkbox y el valor del nombre de la clase. Luego se establece 
    el atributo de checked a true. */
    $(
        "form[name='" +
            a[0].name +
    ...
    /* Cambiar el valor de la casilla de verificación. */
    $(
        "form[name='" +
            a[0].name +
            "'] * input[type='checkbox'][value='" +
...
$("#menu_estado_actual_movil").click(function () {
    $("#lin_movil").show();
    if (!($("#menu_estado_actual_movil").hasClass("desactivo"))) {
        if ($("#menu_estado_actual_movil").hasClass("menu-activo")) {
            $("#submenu_paso1_movil").attr("style", "display:none");
            $("#menu_estado_actual_movil").removeClass("menu-activo");
            hideSubMenus();
        } else {
            hideMenus();
            $("#submenu_paso1_movil").attr("style", "display:grid");
            $("#menu_estado_actual_movil").addClass("menu-activo");
        }
    }
});
...
$("#menu_materiales_movil").click(function () {
    $("#lin_movil").show();
    if ($("#menu_materiales_movil").hasClass("menu-activo")) {
        $("#opciones_estilos").attr("style", "display:none");
        $("#menu_materiales_movil").removeClass("menu-activo");
        hideSubMenus();
    } else {
        hideMenus();
        $("#opciones_estilos").attr("style", "display:grid");
...
$("#menu_equipamiento_movil").click(function () {
    $("#lin_movil").show();
    if ($("#menu_equipamiento_movil").hasClass("menu-activo")) {
...
$("#menu_plano_movil_2").click(function () {
    hideSubMenusPasos();
    $("#menu_plano_movil_2").addClass("menu-activo");
    $("#opciones_crear_plano").show();
});
...
$("#menu_mobiliario_movil_2").click(function () {
    hideSubMenusPasos();

    $("#menu_mobiliario_movil_2").addClass("menu-activo");
    $("#opciones_mobiliario").show();
...
$("#menu_instalaciones_movil_2").click(function () {
    hideSubMenusPasos();
    $("#menu_instalaciones_movil_2").addClass("menu-activo");
    $("#opciones_instalaciones").show();
...
$("#observaciones_movil_2").click(function () {
    hideSubMenusPasos();
    $("#opciones_observacion").addClass("menu-activo");
    $("#opciones_observacion").show();
});

function hideSubMenusPasos(){
    ...
    $("#menu_plano_movil_2").removeClass("menu-activo");
    $("#menu_mobiliario_movil_2").removeClass("menu-activo");
    $("#menu_instalaciones_movil_2").removeClass("menu-activo");
    $("menu_materiales_movil_2").removeClass("menu-activo");
