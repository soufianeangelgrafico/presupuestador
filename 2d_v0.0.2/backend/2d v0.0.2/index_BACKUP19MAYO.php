...
<head>
	...
	#menu_plano, #menu_mobiliario, #menu_instalaciones,#menu_sc {
     width: 33%;
     display: inline-block;
     padding: 25px;
		min-height:120px;
 ...
 <div id="parte_superior">
	...
	<div id="menu_planificador">
		...
		<?php
		 ...
		 {
		?>
		  <div id="menu_sc"><h2 class="titular-planificador"><span class="paso-menu">4.</span> <b style="color:black">PASO 4:</b> S/C</h2></div>
		  <div id="listado_sc">
