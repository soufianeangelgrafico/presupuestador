 <div class="row">  
		...
		<div class="row"> 
		 <div class="col-md-12">
			<ul>
		  <?php
			$result_centros=$mysqli->query("SELECT * FROM centros,administradores_centros WHERE administradores_centros.id_centro = centros.id_centro AND administradores_centros.id_administrador=".$obj_admin->id);
