		   ...
		   <div class="col-md-12">	  
				 <div class="table-responsive">
				  <table class="table">
					...
					<?php
					  $result_fechas=$mysqli->query("SELECT * FROM horarios_calendario WHERE id_centro = $id_centro AND fecha >= '$fecha' ORDER BY fecha,hora ASC LIMIT " . $inicio . "," .$cantidad_resultados_por_pagina);
