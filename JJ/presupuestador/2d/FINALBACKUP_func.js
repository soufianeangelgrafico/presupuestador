...
function carpentryCalc(classObj, typeObj, sizeObj, thickObj, dividerObj = 10) {
  ...
  if (classObj == 'energy') {
	...
	*/
	...
	if (typeObj == 'lavavajillas')
	{
		
		construc.push({'path': "M0 0L0 377L377 377L377 94L377 24C377 19.1866 379.455 4.24219 375.397 1.02777C370.71 -2.68451 355.846 0 350 0L278 0L0 0z", 'stroke': "", 'strokeDashArray': typeObj+" fillnegro escalado"});
		construc.push({'path': "M376 0L377 1L376 0M4 4L4 373L373 373L373 4L4 4z", 'stroke': "", 'strokeDashArray': typeObj+" fillblanco escalado"});
		...
		construc.push({'path': "M0 377L0 378L377 378L344 377L267 377L0 377z", 'stroke': "", 'strokeDashArray': typeObj+" fillblanco escalado"});
	...
	if (typeObj == 'lavadora')
	{
		...
		construc.push({'path': "M0 0L0 283L0 353C0 358.833 -2.55563 373.019 2 377C-3.64934 353.271 1 323.405 1 299L1 138L1 46C1 31.3544 -1.39777 14.2715 2 0L0 0z", 'stroke': "", 'strokeDashArray': typeObj+" fillblanco escalado"});
		...
		construc.push({'path': "M377 0L378 1L377 0M379 0L380 1L379 0M5 4L5 373L374 373L374 4L5 4z", 'stroke': "", 'strokeDashArray': typeObj+" fillblanco escalado"});
	...
	if (typeObj == "mueble-alto-microondas")
	{
		...
		construc.push({'path': "M3109 1611 c-35 -34 -39 -44 -39 -87 0 -129 138 -191 227 -101 90 89 28 227 -101 227 -43 0 -53 -4 -87 -39z m162 -30 c61 -62 14 -161 -76 -161 -42 0 -85 50 -85 98 0 86 99 125 161 63z", 'stroke': "", 'strokeDashArray': typeObj+" fillnegro escaladogeneral"});
		...
		construc.push({'path': "M3133 1100 c-57 -34 -81 -119 -50 -180 32 -63 130 -89 193 -51 35 21 64 75 64 118 0 99 -121 166 -207 113z m123 -38 c33 -26 47 -60 40 -98 -14 -70 -97 -97 -155 -48 -87 73 27 218 115 146z", 'stroke': "", 'strokeDashArray': typeObj+" fillnegro escaladogeneral"});
		...
		construc.push({'path': "M1882 664 c-51 -26 -75 -83 -75 -174 0 -91 19 -142 65 -170 90 -57 178 29 178 174 0 134 -79 214 -168 170z m95 -66 c12 -23 17 -56 17 -108 0 -94 -21 -140 -63 -140 -51 0 -66 30 -66 134 0 109 16 146 65 146 23 0 33 -7 47 -32z", 'stroke': "", 'strokeDashArray': typeObj+" fillnegro escaladogeneral"});
