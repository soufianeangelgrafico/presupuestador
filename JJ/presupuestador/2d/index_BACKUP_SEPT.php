...
<head>
    ...
    transform: scale(0.095); /* 0.12*/
} 
		/*path[stroke-dasharray="boundingbox"] {
    ...
    border: 1px solid #95C124;
		...
		{
			div#armarios_bajos > ul,div#armarios_altos> ul {
				list-style: none;
				padding-left:0;
			}
			div#armarios_bajos * li,div#armarios_altos * li {
    			display: inline-block;
			}
    ...
    display: none;
	   ...
	   {
		   div#panel_informacion {
				padding-top: 10px;
			}
		   #menu_plano {display:none;}
		  div#header {
			 padding: 10px;  	
		  }
		  #opciones_instalaciones * li.submenu_instalaciones {
		 ...
		 #menu_mobiliario, #menu_instalaciones, #menu_materiales {
			display: none;
		 }  
...
?>	 
 <div id="parte_superior">
	...
	<div id="menu_planificador">
		...
		<div class="menu-activo"><h2 class="titular-planificador"><span class="paso-menu">2.</span> <b style="color:black">PASO 2:</b> ESTADO REFORMADO</h2></div>
		
		<div id="menu_plano"><h5 class="subtitular-planificador">PASO 2.1: TABIQUES, PUERTAS Y VENTANAS <i class="fa fa-info-circle" onclick="instrucciones('paso21')"></i></h5></div>
		
		<div id="menu_mobiliario"><h5 class="subtitular-planificador">2.2: MOBILIARIO Y ELECTRODOMÉSTICOS</h5></div>
				 ...
				 <?php
	 				for ($i=1;$i<=99;$i++)
					{
					  if ($i < 10)
					   ...
					   $value="2.".$i;
				 ?>
				<option value="<?php echo $value;?>" <?php if ($altura_pared == $value) { ?>selected <?php } ?>><?php echo $value;?> m</option>
				 <?php
					}
				 ?>	
				<?php
	 ...
	 <div id="opciones_mobiliario" style="display:none">
		 ...
		 <div id="armarios_bajos">
			 <ul class="owl-carousel owl-theme">
			  <li><img src="armarios_inferiores/armario_bajo600_front.png" class="btn fully object" id="bajo1" width="83" style="width:83px"></li>
			  <li><img src="armarios_inferiores/armario_bajo600x500_front.png" class="btn fully object" id="bajo2" style="width:83px"></li>
			  <li><img src="armarios_inferiores/armario_bajo600x450_front.png" class="btn fully object" id="bajo3" style="width:83px"></li>
			  <li><img src="armarios_inferiores/armario_bajo600x400_front.png" class="btn fully object" id="bajo4" style="width:83px"></li>
			  <li><img src="armarios_inferiores/armario_bajo600x300_front.png" class="btn fully object" id="bajo5" style="width:83px"></li>
			  <li><img src="armarios_inferiores/armario_bajo600x200_front.png" class="btn fully object" id="bajo6" style="width:83px"></li>
			 </ul>
			</div>	
		 ...
		 <div id="armarios_altos">
		  <ul class="owl-carousel owl-theme">	 
			<li><img src="armarios_superiores/armario_superior376x600_front.png" class="btn fully object" id="alto1" width="65" style="width:83px"></li>
			<li><img src="armarios_superiores/armario_superior376x500_front.png" class="btn fully object" id="alto2" width="65" style="width:83px"></li>
			<li><img src="armarios_superiores/armario_superior376x400_front.png" class="btn fully object" id="alto3" width="65" style="width:83px"></li>
			<li><img src="armarios_superiores/armario_superior376x300_front.png" class="btn fully object" id="alto4" width="65" style="width:83px"></li>
			<li><img src="armarios_superiores/armario_superior376x200_front.png" class="btn fully object" id="gtl" width="65" style="width:83px"></li>
		   </ul>
		 </div>
						 ...
						 <form class="form_unidades" name="<?php echo $arr_result['id_imagen'];?>" method="POST" action="#">
						  ...
						  <select class="form-control <?php echo $arr_result['id_imagen'];?>" name="unidades" <?php if ($arr_result["mostrar"] == "") { ?> style="display:none;"<?php } ?>>
							<?php
							 ...
							 {
							?>	 
							   <option <?php if (isset($_GET["id_presupuesto"]) && $unidades == $i) { ?> selected <?php } ?> value="<?php echo $i;?>"><?php echo $i;?> <?php if ($i == 1) { ?>unidad <?php } else { ?>unidades<?php } ?></option>
							<?php	 
							 }
						  	?>
