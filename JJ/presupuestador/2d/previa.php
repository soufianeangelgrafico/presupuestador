    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn greenBtn" data-dismiss="modal">Cancelar</button>
 ...
 <div id="parte_superior">
	...
	<div id="menu_planificador_movil">
	 <div class="paso_menu_movil menu-activo">PASO 1: ESTADO ACTUAL</div>
 	 <div class="paso_menu_movil">1.1: TABIQUES, PUERTAS Y VENTANAS</div>
	 <div class="paso_menu_movil">1.2: MOBILIARIO Y ELECTRODOMÉSTICOS</div>
	 <div class="paso_menu_movil">1.3: INSTALACIONES</div>
	 <div class="paso_menu_movil">1.4: OBSERVACIONES</div>
	</div> 
	...
	<div id="menu_planificador">
            <div class="divmenu menu-activo">
                ...
                <div class="divmenu menu-activo" id="tabiques"><h5 class="subtitular-planificador"><div class="submenu-header" ><b>PASO_1.1</b></div><b>TABIQUES, PUERTAS Y VENTANAS</b><br> <i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso11')"></i></h5></div>
		<div class="divmenu" id="mobiliario"><h5 class="subtitular-planificador"><div class="submenu-header"><b>PASO_1.2</b></div><b> MOBILIARIO Y ELECTRODOMÉSTICOS </b><br><i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso12')"></i></h5></div>
		<div class="divmenu" id="instalaciones"><h5 class="subtitular-planificador"><div class="submenu-header"><b>PASO_1.3</b></div><b>INSTALACIONES </b><br><i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso13')"></i></h5></div>
		<div class="divmenu" id="observaciones"><h5 class="subtitular-planificador"><div class="submenu-header"><b>PASO_1.4</b></div><b> OBSERVACIONES</b><br> <i class="fa fa-info-circle instructionsBtn" onclick="instrucciones('paso14')"></i></h5></div>
                <?php
	...
	<div id="panel_informacion">
	 ...
	 <div id="opciones_mobiliario" style="">
	 ...
	 <div id="opciones_crear_plano">
		  ...
		  <div id="panel">
			 ...
			 ?>
				<button class="btn greenBtn"" id="line_mode" data-toggle="tooltip" data-placement="right" title="Comenzar a dibujar">
			...
			<div id="informacion_pared">
				...
				<output style="display:inline-block; color:#95C11F; font-size: 1em">2</output> M
