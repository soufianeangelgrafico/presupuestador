...
$result_id_usuario=$mysqli->query("SELECT id_usuario,total_paredes_reformado FROM clientes WHERE id_presupuesto=$id_presupuesto AND total_paredes_reformado != '' ORDER BY id_presupuesto DESC LIMIT 1");

while ($arr_result_id_usuario = $result_id_usuario->fetch_array())
{
  $id_usuario=$arr_result_id_usuario["id_usuario"];
  $total_paredes=$arr_result_id_usuario["total_paredes_reformado"];
...
if (!$result_elemento->num_rows)
{
    ...
    //echo "SELECT * FROM materiales WHERE referencia='$elemento'";
		...
		while ($arr_result_material = $result_material->fetch_array())
		{
		  ...
		  if ($arr_result_material["mostrar"] == "muros")
		  {
			...
			for ($i=0;$i<count($paredes);$i++)
			{
				...
				$mysqli->query("INSERT clientes(id_usuario,referencia_material,paredes_reformado,longitud_pared_reformado,altura_techo_reformado,total_paredes_reformado,id_presupuesto_modificado) VALUES($id_usuario,'$elemento','$pared_actual','$longitud_pared','$altura_paredes','$total_paredes',$id_presupuesto)");
				 
				//echo "INSERT clientes(id_usuario,referencia_material,paredes_reformado,longitud_pared_reformado,altura_techo_reformado,total_paredes_reformado,id_presupuesto_modificado) VALUES($id_usuario,'$elemento','$pared_actual','$longitud_pared','$altura_paredes','$total_paredes',$id_presupuesto)";
		  ...
		  {
			$mysqli->query("INSERT clientes(id_usuario,referencia_material,id_presupuesto_modificado) VALUES($id_usuario,'$elemento',$id_presupuesto)");
			//echo "INSERT clientes(id_usuario,referencia_material,id_presupuesto_modificado) VALUES($id_usuario,'$elemento',$id_presupuesto)";
		  }
		}
...
else
{
		...
		for ($i=0;$i<count($paredes);$i++)
		{
			...
			if (isset($_POST["articulo_simple"]))
			{
				for ($x=0;$x<count($articulo_simple);$x++)
				{
				  ...
				  $id_articulo_simple_actual=$articulo_simple[$x];
				  $mysqli->query("INSERT clientes(id_usuario,id_articulo_compuesto,id_articulo_simple,paredes_reformado,longitud_pared_reformado,altura_techo_reformado,total_paredes_reformado,id_presupuesto_modificado) VALUES($id_usuario,$id_articulo_compuesto,$id_articulo_simple_actual,'$pared_actual','$longitud_pared','$altura_paredes','$total_paredes',$id_presupuesto)");
				
				  //echo "Articulo simple: <br/>";
					
				  //echo "INSERT clientes(id_usuario,id_articulo_compuesto,id_articulo_simple,paredes_reformado,longitud_pared_reformado,altura_techo_reformado,total_paredes_reformado,id_presupuesto_modificado) VALUES($id_usuario,$id_articulo_compuesto,$id_articulo_simple_actual,'$pared_actual','$longitud_pared','$altura_paredes','$total_paredes',$id_presupuesto)<br/>";	

				}
			}
			else 
			{
				$mysqli->query("INSERT clientes(id_usuario,id_articulo_compuesto,paredes_reformado,longitud_pared_reformado,altura_techo_reformado,total_paredes_reformado,id_presupuesto_modificado) VALUES($id_usuario,$id_articulo_compuesto,'$pared_actual','$longitud_pared','$altura_paredes','$total_paredes',$id_presupuesto)");
				
				//echo "Artículo compuesto: <br/>";
				//echo "INSERT clientes(id_usuario,id_articulo_compuesto,paredes_reformado,longitud_pared_reformado,altura_techo_reformado,total_paredes_reformado,id_presupuesto_modificado) VALUES($id_usuario,$id_articulo_compuesto,'$pared_actual','$longitud_pared','$altura_paredes','$total_paredes',$id_presupuesto)<br/>";
	...
	else if ($mostrar == "metros_lineales")
	{
	    ...
	    $suma_precios=$suma_precios+$precio_final;
		 ...
		 for ($x=0;$x<count($articulo_simple);$x++)
		  ...
		  $id_articulo_simple_actual=$articulo_simple[$x];
		  $mysqli->query("INSERT clientes(id_usuario,id_articulo_compuesto,id_articulo_simple,total_paredes_reformado,metros_lineales_reformado,id_presupuesto_modificado) VALUES($id_usuario,$id_articulo_compuesto,$id_articulo_simple_actual,'$total_paredes','$metros_lineales',$id_presupuesto)");
	...
	else
	{
	  ...
	  for ($x=0;$x<count($articulo_simple);$x++)
	  {
		 ...
		 $id_articulo_simple_actual=$articulo_simple[$x];
		 $mysqli->query("INSERT clientes(id_usuario,id_articulo_compuesto,id_articulo_simple,total_paredes_reformado,unidades_reformado,id_presupuesto_modificado) VALUES($id_usuario,$id_articulo_compuesto,$id_articulo_simple_actual,'$total_paredes','$unidades',$id_presupuesto)");
