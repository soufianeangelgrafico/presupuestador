...
?>	 
 <div id="parte_superior">
	...
	<div id="menu_planificador">
		...
		<div id="menu_estado_reformado" class="divmenu"><h2 class="titular-planificador"><span class="paso-menu">2.</span> <b style="color:black">PASO 2:</b> ESTADO REFORMADO</h2></div>
		
		<div id="submenu_paso2">
			<div class="divmenu" id="menu_plano"><h5 class="subtitular-planificador">2.1: TABIQUES, PUERTAS Y VENTANAS <i class="fa fa-info-circle" onclick="instrucciones('paso21')"></i></h5></div>
		...
		<div class="divmenu" id="menu_trabajos">
			<h2 class="titular-planificador"><span class="paso-menu">3</span><b style="color:black"> PASO 3:</b> TRABAJOS A REALIZAR <i class="fa fa-info-circle" onclick="instrucciones('paso23')"></i></h2>
		...
		<div id="menu_materiales">
			<h2 class="titular-planificador"><span class="paso-menu">4.</span> <b style="color:black">PASO 4:</b> MATERIALES</h2></div>  
	...
	<div id="panel_informacion">
	 ...
	 <div id="opciones_observacion" style="display:none;">
		 ...
		 <div id="anotaciones_observacion">
		   <?php echo $observaciones_estado_actual;?>
