  ...
  function _MOUSEMOVE(event) {
    ...
    if (mode == 'object_mode') {
      ...
      if (typeof(binder) == 'undefined') {
        ...
        if ( ((binder.family != 'stick' && binder.family != 'collision') || WALLS.length == 0) && binder.type != "segment") {
          binder.x = snap.x;
          binder.y = snap.y;
...
console.log("ES OFF!"); 
                  ...
                  if (mode == 'partition_mode') ws = 5; //antes 10
                   ...
                   // console.log("Wall size - Aquí calcula los m2 cuando estás creando la línea - Distance");
                    ...
                    if (typeof(lengthTemp) != 'undefined' && valueText > 0.1)
                    {
                      ...
                      lengthTemp.textContent = valueText + ' m2';
                    }
                    if (typeof(lengthTemp) != 'undefined' && valueText < 0.1)
                    {
  ...
  // **********************************************************************
    ...
    if (mode == 'select_mode' && drag == 'on') {
		...
		if (document.getElementById("muro1"))
  ...
  function _MOUSEUP(event) {
	  ...
	  */
		 ...
		 */
		 ...
		 if (id_objeto_actual == "alto1")
		 {
		   ...
		   sizeText[1] = document.createElementNS('http://www.w3.org/2000/svg', 'text');
		   ...
		   $("path[stroke-dasharray='alto1 fillblue']").parent().append($(sizeText[1]));  
		 }
		 else if (id_objeto_actual == "alto2")
		 {
		  ...
		  // $("path[stroke-dasharray='alto2 fillblue']").parent().append($(sizeText[0])); 
		   $("path[stroke-dasharray='alto2 fillblue']").parent().append($(sizeText[1])); 
		 ...
		 else if (id_objeto_actual == "alto3")
		 {
		   ...
		   $("path[stroke-dasharray='alto3 fillblue']").parent().append($(sizeText[1]));  
		 }
		 else if (id_objeto_actual == "alto4")
		 {
		   ...
		   $("path[stroke-dasharray='alto4 fillblue']").parent().append($(sizeText[1]));
		 ...
		 else if (id_objeto_actual == "alto5")
		 {
		   ...
		   $("path[stroke-dasharray='alto5 fillblue']").parent().append($(sizeText[1]));  
		 }
		 else if (id_objeto_actual == "bajo1")
		 {
		   ...
		   $("path[stroke-dasharray='bajo1 fillnegro']").parent().append($(sizeText[1])); 
		 }
		 else if (id_objeto_actual == "bajo2")
		 {
		   ...
		   $("path[stroke-dasharray='bajo2 fillnegro']").parent().append($(sizeText[1]));  
		 }
		 else if (id_objeto_actual == "bajo3")
		 {
		   ...
		   $("path[stroke-dasharray='bajo3 fillnegro']").parent().append($(sizeText[1])); 
		 }
		 else if (id_objeto_actual == "bajo4")
		 {
		   ...
		   $("path[stroke-dasharray='bajo4 fillnegro']").parent().append($(sizeText[1])); 
		 ...
		 else if (id_objeto_actual == "bajo5")
		 {
		  ...
		  // $("path[stroke-dasharray='bajo5 fillnegro']").parent().append($(sizeText[0])); 
		   $("path[stroke-dasharray='bajo5 fillnegro']").parent().append($(sizeText[1])); 
		 }
		 else if (id_objeto_actual == "bajo6")
		 {
		  ...
		  // $("path[stroke-dasharray='bajo6 fillnegro']").parent().append($(sizeText[0])); 
		   $("path[stroke-dasharray='bajo6 fillnegro']").parent().append($(sizeText[1]));  
		 }
		 else if (id_objeto_actual == "lavadora") 
		 {
		   ...
		   $("path[stroke-dasharray='lavadora fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='lavadora fillnegro']").parent().append($(sizeText[1])); 
			 
		   sizeText[2] = document.createElementNS('http://www.w3.org/2000/svg', 'text');
		   ...
		   $("path[stroke-dasharray='lavadora fillnegro']").parent().append($(sizeText[2])); 
		 ...
		 else if (id_objeto_actual == "campana") 
		 {
		   ...
		   $("path[stroke-dasharray='campana fillnegro']").parent().append($(sizeText[0]));
		 ...
		 else if (id_objeto_actual == "lavavajillas") 
		 {
		   ...
		   $("path[stroke-dasharray='lavavajillas fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='lavavajillas fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='lavavajillas fillnegro']").parent().append($(sizeText[2])); 	 
			 
		   sizeText[3] = document.createElementNS('http://www.w3.org/2000/svg', 'text');
		   ...
		   $("path[stroke-dasharray='lavavajillas fillnegro']").parent().append($(sizeText[3]));
		 ...
		 else if (id_objeto_actual == "horno") 
		 {
		   ...
		   $("path[stroke-dasharray='horno fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='horno fillnegro']").parent().append($(sizeText[1])); 
		 ...
		 else if (id_objeto_actual == "vitro_induccion") 
		 {
		   ...
		   $("path[stroke-dasharray='vitro_induccion fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='vitro_induccion fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='vitro_induccion fillnegro']").parent().append($(sizeText[2])); 	 
		   ...
		   $("path[stroke-dasharray='vitro_induccion fillnegro']").parent().append($(sizeText[3]));
		 ...
		 else if (id_objeto_actual == "placa_gas") 
		 {
		   ...
		   $("path[stroke-dasharray='placa_gas fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='placa_gas fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='placa_gas fillnegro']").parent().append($(sizeText[2])); 
		 ...
		 else if (id_objeto_actual == "micro") 
		 {
		   ...
		   $("path[stroke-dasharray='micro fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='micro fillnegro']").parent().append($(sizeText[1])); 
		 ...
		 else if (id_objeto_actual == "frigo") 
		 {
		   ...
		   $("path[stroke-dasharray='frigo fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='frigo fillnegro']").parent().append($(sizeText[1])); 
		 ...
		 else if (id_objeto_actual == "secadora") 
		 {
		   ...
		   $("path[stroke-dasharray='secadora fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='secadora fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='secadora fillnegro']").parent().append($(sizeText[2])); 
		 ...
		 else if (id_objeto_actual == "fregadero") 
		 {
		   ...
		   $("path[stroke-dasharray='fregadero fillnegro']").parent().append($(sizeText[0]));
		   ...
		   $("path[stroke-dasharray='fregadero fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='fregadero fillnegro']").parent().append($(sizeText[2])); 
		 ...
		 else if (id_objeto_actual == "lavadero") 
		 {
		   ...
		   $("path[stroke-dasharray='lavadero fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='lavadero fillnegro']").parent().append($(sizeText[2])); 
		 ...
		 else if (id_objeto_actual == "termo_electrico") 
		 {
		   ...
		   $("path[stroke-dasharray='termo_electrico fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='termo_electrico fillnegro']").parent().append($(sizeText[2])); 
		 ...
		 else if (id_objeto_actual == "calentador_gas") 
		 {
		   ...
		   $("path[stroke-dasharray='calentador_gas fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='calentador_gas fillnegro']").parent().append($(sizeText[2])); 
		 ...
		 else if (id_objeto_actual == "caldera_gas") 
		 {
		   ...
		   $("path[stroke-dasharray='caldera_gas fillnegro']").parent().append($(sizeText[1])); 
		   ...
		   $("path[stroke-dasharray='caldera_gas fillnegro']").parent().append($(sizeText[2])); 
    ...
    if (mode == 'line_mode' || mode == 'partition_mode') {
        ...
        if ($('#line_construc').length && sizeWall > 0.3) {
          ...
          $('#boxinfo').html('Muro creado <span style=\'font-size:0.6em\'>Moy. ' + (qSVG.measure(
        ...
        if (typeof(binder) != 'undefined') {
            ...
            if (binder.type == 'segment') {
              ...
              if (found) {
                //$('#panel').hide(100);
                var objWall = editor.objFromWall(wallBind);
                $('#boxinfo').html('Modififca el muro<br/><span style="font-size:0.7em;color:#de9b43">Este muro no puede convertirse en una separación (contiene puertas o ventanas) !</span>');
				...
				document.getElementById('wallWidth').className = binder.wall.graph.context.id
          ...
          if (binder.type == 'obj') {
            ...
            if (moveObj < 1) {
              ...
              $('#objTools').show('200', function() {
				...
				{
				  $('#doorWindowHeight').val(binder.obj.params.resizeLimit.height.min);
				  $('#doorWindowHeight + output').html(binder.obj.params.resizeLimit.height.min);
				}
				else
				{
...
setInterval(function(){ 
	...
	if (objetos_plano.top != 0 && objetos_plano.right != 0 && objetos_plano.bottom != 0 && objetos_plano.left != 0 && contador > 0)
	{
		...
		{
		 //OK	 
		  var primer_muro=document.getElementById("muro1").getBoundingClientRect();
		  $("#boxEnergy > g").each(function(){
			  ...
			  var startText = qSVG.middle(primer_muro.top, primer_muro.left, objeto.top, objeto.left);
