...
// >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> TE QUEDASTE AQUÍ !!!!!!
    for (var vertice = 0; vertice < WALLS.length; vertice++) {
     ...
     // var wallThickY = 0;	
  	...
  	console.log("equal wall up");
		console.log(eqWallUp);
	console.log("equal wall down");
		console.log(eqWallDw);
      ...
      // WALL STARTED
		var i=0; // inicializo i a 0 para que no detecte ninguna pared "padre" o "hijo" para que así el valor de los m2 lo haga correcto.
		
      if (wall.parent == null || i == 0) {
	  ...
	  if ($("#muro1").length)
      {
		 var rect = document.getElementById("muro1").getBoundingClientRect();
		 if (rect.top != rect.bottom && (rect.bottom - rect.top > 30))
		 {
			 //alertify.error("El primer muro debe ser el superior (en horizontal). Vuelve a dibujarlo");
  ...
  makeWall: function(way) {
	 //console.log("Make Wall "+way);
	 if ($("#muro1").length == 0)
      {
		  var ruta="muro1";
	  } 
	  else if ($("#muro2").length == 0 )
		  var ruta="muro2";
	  else if ($("#muro3").length == 0 )
		  var ruta="muro3";
	  else if ($("#muro4").length == 0 )
		  var ruta="muro4";
	  else if ($("#muro5").length == 0 )
		  var ruta="muro5";
	  else if ($("#muro6").length == 0 )
		  var ruta="muro6";
	  else if ($("#muro7").length == 0 )
		  var ruta="muro7";
	  else if ($("#muro8").length == 0 )
		  var ruta="muro8";
	  else if ($("#muro9").length == 0 )
		  var ruta="muro9";
	  else if ($("#muro10").length == 0 )
		  var ruta="muro10";
	  else if ($("#muro11").length == 0 )
		  var ruta="muro11";
	  else if ($("#muro12").length == 0 )
		  var ruta="muro12";
	  else if ($("#muro13").length == 0 )
		  var ruta="muro13";
	  else if ($("#muro14").length == 0 )
		  var ruta="muro14";
	  else if ($("#muro15").length == 0 )
		  var ruta="muro15";
	  else if ($("#muro16").length == 0 )
		  var ruta="muro16";
	  else if ($("#muro17").length == 0 )
		  var ruta="muro17";
	  else if ($("#muro18").length == 0 )
		  var ruta="muro18";
	  else if ($("#muro19").length == 0 )
		  var ruta="muro19";
	  else if ($("#muro20").length == 0 )
		  var ruta="muro20";
	  
	  console.log("!!!WAY!!!ª");
	  console.log(way);
	  //alert($("#"+ruta).attr("fill"));
  ...
  architect: function(WALLS) {
	  //console.log("entro en la funcion architect pasando walls como parámetro");
	  //console.log(WALLS);
      ...
      this.update = function() {
        ...
        for (var tt = 0; tt < cc.length; tt++) {
            if (cc[tt].path)  {
			  ...
			  //this.graph.find('path')[tt].setAttribute("title",Math.random() * 10);
  ...
  roomMaker:  function(Rooms) {
    ...
    for (var rr = 0; rr < ROOM.length; rr++) {
		...
		//Cuando ha terminado de generar el dibujo (ha unido todos los muros) por defecto hago un trigger
		//De select mode, porque si no, en versión móvil, cuando me muevo por la pantalla, me sigue dibujando muros
		
		$("#select_mode").trigger("click");
        ...
        if (ROOM[rr].color == 'gradientBlack' || ROOM[rr].color == 'gradientBlue') styled.color = 'white';
      //  if (ROOM[rr].showSurface) qSVG.textOnDiv(area, centroid, styled, 'boxArea'); OCULTO LOS M2 DENTRO DEL 2D
    }
    if (globalArea <= 0) {
      globalArea = 0;
      $('#areaValue').html('');
