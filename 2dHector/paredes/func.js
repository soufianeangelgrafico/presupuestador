...
paredes_creadas = parseInt(url.searchParams.get("creadas"))+1;
paredes_totales = url.searchParams.get("totales");
	
$('#listado_paredes').append("<b>AHORA: Creando pared "+paredes_creadas+"</b> / "+paredes_totales); 
$('#numero_pared_modal').append(paredes_creadas); 
$('#total_pared_modal').append(paredes_totales); 

if (localStorage.getItem('pared'+paredes_creadas) != null)
{
	
	$('.modal-body').prepend("<p id='mensaje_creada' style='font-size:12px;margin-top:10px;'>* Esta pared ya la has creado anteriormente. Puedes guardar un nuevo dibujo o hacer clic en SALTAR para no sobreescribirlo. Recuerda que también puedes ver el dibujo de esta pared en el listado</p>"); 
	
}
	
	
	$('#listado_paredes').append("<p><b>Paredes creadas</b></p>");	
	for (i=1;i<paredes_totales;i++)
	{
	 pared_anterior=i-1;
	 if (localStorage.getItem('pared'+i) == null)
	 {
		 
	 }
	 else
	 {
	    $('#listado_paredes').append("<a href='https://rehubik.com/presupuestador/2d/paredes/ver_pared.html?creadas="+pared_anterior+"&totales="+paredes_totales+"'>Pared "+i+"</a><br/>");	
	 }
	}

	
if (localStorage.getItem('total_paredes') == null)
  localStorage.setItem('total_paredes', paredes_totales);
      ...
      for (var n = 1; n < ribMaster[t][a].length; n++) {
        ...
        if (ribMaster[t][a][n-1].wallIndex == ribMaster[t][a][n].wallIndex) {
          ...
          if (found) {
			  ...
			  //<< comentar esto para que no se vean los m2 de cada pared
              //$('#boxRib').append(sizeText[n]); 
			   $('#listado_muros').append("<b>Muro "+contador_muro+"</b> ["+letras_abecedario[contador_muro-1]+"] con valor "+valueText.toFixed(2).substring(0,valueText.toFixed(2).length -1)+" | "); 
          }
        }
      }
    }
...
$('.door').click(function() {
    $('#lin').css('cursor', 'crosshair');
    $('#boxinfo').html('Agregar una puerta');
    $('#door_list').hide(200);
...
function carpentryCalc(classObj, typeObj, sizeObj, thickObj, dividerObj = 10) {
  ...
  if (classObj == 'energy') {
	...
	if (typeObj == 'bajo1')
	{
      ...
      construc.push({'path': "M 14 75.027344 C 14 75.914062 14.722656 76.636719 15.609375 76.636719 L 18.183594 76.636719 L 18.183594 78.449219 C 18.183594 80.515625 21.402344 80.519531 21.402344 78.449219 L 21.402344 76.636719 L 58.597656 76.636719 L 58.597656 78.449219 C 58.597656 80.515625 61.816406 80.519531 61.816406 78.449219 L 61.816406 76.636719 L 64.390625 76.636719 C 65.277344 76.636719 66 75.914062 66 75.027344 L 66 1.609375 C 66 0.722656 65.277344 0 64.390625 0 L 15.609375 0 C 14.722656 0 14 0.722656 14 1.609375 Z M 62.78125 54.964844 L 62.78125 62.566406 L 17.21875 62.566406 L 17.21875 54.964844 Z M 62.78125 51.746094 L 41.609375 51.746094 L 41.609375 23.992188 C 41.609375 21.925781 38.390625 21.921875 38.390625 23.992188 L 38.390625 51.746094 L 17.21875 51.746094 L 17.21875 3.21875 L 38.390625 3.21875 L 38.390625 10.839844 C 38.390625 12.90625 41.609375 12.910156 41.609375 10.839844 L 41.609375 3.21875 L 62.78125 3.21875 Z M 62.78125 73.417969 L 17.21875 73.417969 L 17.21875 65.789062 L 62.78125 65.789062 Z M 62.78125 73.417969 ", 'stroke': "", 'strokeDashArray': ''});
		
	construc.push({'path': "M 41.484375 58.152344 C 41.152344 57.339844 40.191406 56.945312 39.382812 57.28125 C 38.574219 57.617188 38.175781 58.570312 38.511719 59.382812 C 38.847656 60.191406 39.808594 60.585938 40.617188 60.253906 C 41.425781 59.917969 41.824219 58.960938 41.484375 58.152344 Z M 41.484375 58.152344 ", 'stroke': "", 'strokeDashArray': ''});
		
		construc.push({'path': "M 38.511719 70.21875 C 38.773438 70.851562 39.4375 71.261719 40.117188 71.207031 C 40.804688 71.152344 41.390625 70.660156 41.5625 69.992188 C 41.914062 68.601562 40.328125 67.488281 39.128906 68.25 C 38.484375 68.664062 38.21875 69.511719 38.511719 70.21875 Z M 38.511719 70.21875 ", 'stroke': "", 'strokeDashArray': ''});
		
		construc.push({'path': "M 46.496094 35.238281 C 47.386719 35.238281 48.105469 34.519531 48.105469 33.628906 L 48.105469 29.226562 C 48.105469 27.160156 44.886719 27.15625 44.886719 29.226562 L 44.886719 33.628906 C 44.886719 34.519531 45.609375 35.238281 46.496094 35.238281 Z M 46.496094 35.238281 ", 'stroke': "", 'strokeDashArray': ''});
		
		
		construc.push({'path': "M 33.378906 27.617188 C 32.492188 27.617188 31.769531 28.335938 31.769531 29.226562 L 31.769531 33.628906 C 31.769531 35.695312 34.988281 35.699219 34.988281 33.628906 L 34.988281 29.226562 C 34.988281 28.335938 34.269531 27.617188 33.378906 27.617188 Z M 33.378906 27.617188 ", 'stroke': "", 'strokeDashArray': ''});
		
		
		construc.push({'path': "M 38.511719 17.949219 C 38.851562 18.757812 39.804688 19.15625 40.617188 18.816406 C 41.425781 18.480469 41.820312 17.53125 41.484375 16.71875 C 41.152344 15.90625 40.191406 15.507812 39.382812 15.847656 C 38.570312 16.183594 38.179688 17.136719 38.511719 17.949219 Z M 38.511719 17.949219 ", 'stroke': "", 'strokeDashArray': ''});

      construc.params.width = 83;
	...
	if (typeObj == 'bajo2')
	{
      ...
      construc.push({'path': "M 70.828125 0 L 9.171875 0 C 7.878906 0 6.828125 1.050781 6.828125 2.34375 L 6.828125 77.65625 C 6.828125 78.949219 7.878906 80 9.171875 80 L 70.828125 80 C 72.121094 80 73.171875 78.949219 73.171875 77.65625 L 73.171875 2.34375 C 73.171875 1.050781 72.121094 0 70.828125 0 Z M 68.484375 75.3125 L 11.515625 75.3125 L 11.515625 42.34375 L 68.484375 42.34375 Z M 68.484375 37.65625 L 11.515625 37.65625 L 11.515625 4.6875 L 68.484375 4.6875 Z M 68.484375 37.65625 ", 'stroke': "", 'strokeDashArray': ''});
		
	construc.push({'path': "M 63.894531 8.277344 L 16.105469 8.277344 C 14.808594 8.277344 13.761719 9.324219 13.761719 10.621094 L 13.761719 31.722656 C 13.761719 33.019531 14.808594 34.066406 16.105469 34.066406 L 63.894531 34.066406 C 65.191406 34.066406 66.238281 33.019531 66.238281 31.722656 L 66.238281 10.621094 C 66.238281 9.324219 65.191406 8.277344 63.894531 8.277344 Z M 61.550781 29.378906 L 18.449219 29.378906 L 18.449219 12.964844 L 61.550781 12.964844 Z M 61.550781 29.378906 ", 'stroke': "", 'strokeDashArray': ''});
		
		construc.push({'path': "M 44.59375 18.828125 L 35.40625 18.828125 C 34.109375 18.828125 33.0625 19.878906 33.0625 21.171875 C 33.0625 22.464844 34.109375 23.515625 35.40625 23.515625 L 44.59375 23.515625 C 45.890625 23.515625 46.9375 22.464844 46.9375 21.171875 C 46.9375 19.878906 45.890625 18.828125 44.59375 18.828125 Z M 44.59375 18.828125 ", 'stroke': "", 'strokeDashArray': ''});
		
		construc.push({'path': "M 63.894531 45.933594 L 16.105469 45.933594 C 14.808594 45.933594 13.761719 46.980469 13.761719 48.277344 L 13.761719 69.378906 C 13.761719 70.675781 14.808594 71.722656 16.105469 71.722656 L 63.894531 71.722656 C 65.191406 71.722656 66.238281 70.675781 66.238281 69.378906 L 66.238281 48.277344 C 66.238281 46.980469 65.191406 45.933594 63.894531 45.933594 Z M 61.550781 67.035156 L 18.449219 67.035156 L 18.449219 50.621094 L 61.550781 50.621094 Z M 61.550781 67.035156 ", 'stroke': "", 'strokeDashArray': ''});
		
		
		construc.push({'path': "M 44.59375 56.484375 L 35.40625 56.484375 C 34.109375 56.484375 33.0625 57.535156 33.0625 58.828125 C 33.0625 60.121094 34.109375 61.171875 35.40625 61.171875 L 44.59375 61.171875 C 45.890625 61.171875 46.9375 60.121094 46.9375 58.828125 C 46.9375 57.535156 45.890625 56.484375 44.59375 56.484375 Z M 44.59375 56.484375 ", 'stroke': "", 'strokeDashArray': ''});
	...
	if (typeObj == 'bajo3')
	{
      ...
      construc.push({'path': "M 60 2.5 L 20 2.5 C 17.929688 2.5 16.25 4.179688 16.25 6.25 L 16.25 68.75 C 16.25 70.820312 17.929688 72.5 20 72.5 L 20 76.25 C 20 76.941406 20.558594 77.5 21.25 77.5 L 58.75 77.5 C 59.441406 77.5 60 76.941406 60 76.25 L 60 72.5 C 62.070312 72.5 63.75 70.820312 63.75 68.75 L 63.75 6.25 C 63.75 4.179688 62.070312 2.5 60 2.5 Z M 18.75 68.75 L 18.75 6.25 C 18.75 5.558594 19.308594 5 20 5 L 38.75 5 L 38.75 70 L 20 70 C 19.308594 70 18.75 69.441406 18.75 68.75 Z M 57.5 75 L 22.5 75 L 22.5 72.5 L 57.5 72.5 Z M 61.25 68.75 C 61.25 69.441406 60.691406 70 60 70 L 41.25 70 L 41.25 5 L 60 5 C 60.691406 5 61.25 5.558594 61.25 6.25 Z M 61.25 68.75 ", 'stroke': "", 'strokeDashArray': ''});
		
	  construc.push({'path': "M 33.75 30 L 36.25 30 L 36.25 40 L 33.75 40 Z M 33.75 30 ", 'stroke': "", 'strokeDashArray': ''});
		
	  construc.push({'path': "M 43.75 30 L 46.25 30 L 46.25 40 L 43.75 40 Z M 43.75 30 ", 'stroke': "", 'strokeDashArray': ''});
	...
	if (typeObj == 'alto1')
	{
		...
