	...
	<div id="panel_informacion">
	 ...
	 <div id="opciones_estilos" style="display:none;">
        ...
        <div id="opciones_materiales" style="display:none">
            <div id="materiales"> 
                 <div class="texto-li centrado titulo-material buttonTitle" onclick="$('#opciones_materiales').hide();$('#opciones_estilos').show();">
                   ...
                   <button class="btn greenBtn fully " id="frente_armario" onclick="hideStep4SubMenus();$('#frente_armario_list').show();">FRENTE ARMARIO</button>
                    <div id="frente_armario_list" style="display:none;background:#fff;padding:10px;">

                        <button class="materials_submenu_btn" id="aperture">
                            <div style="display:flex;" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/BODBYN/mob_bodbyn_grisclaro.png');">
                                <img src="frenteMobiliario/BodbynGris1.png" style="width:35%">
                                <img src="frenteMobiliario/BodbynGris2.png" style="width:55%">
                            </div>
                          
                        </button>
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/BODBYN/mob_bodbyn_hueso.png');">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/BODBYN/mob_bodbyn_verdeoscuro.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/Combinados/mob_jarsta_turquesabrillo.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="aperture" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/Combinados/mob_sinarp_hasslarp_maderaoscura.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/Combinados/mob_varsta_aceroinoxidable.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/con_marco/mob_lerhyttan_maderanegra.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/con_marco/mob_savedal_blancomate.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="aperture" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/con_marco/mob_torhamn_maderanatural.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/LISO_con_tirador/mob_askersund_madera_fresnoclaro.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/LISO_con_tirador/mob_havstorp_hueso.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/LISO_con_tirador/mob_kallarp_granatebrillo.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="aperture" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/LISO_con_tirador/mob_kungsbaka_negromate.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/LISO_con_tirador/mob_ringhult_blancobrillo.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/LISO_con_tirador/mob_veddinge_blancomate.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/Voxtorp/mob_linea_voxtorp_blanco_brillo.png');">
                            <div style="display:flex;">
                         ...
                         <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/Voxtorp/mob_linea_voxtorp_blanco_mate.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/Voxtorp/mob_linea_voxtorp_grisoscuro_mate.png');">
                            <div style="display:flex;">
                         ...
                         <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(1,'CapasCocina/MOBILIARIO/Voxtorp/mob_linea_voxtorp_madera.png');">
                            <div style="display:flex;">
                   ...
                   <button class="btn greenBtn fully " id="encimera" onclick="hideStep4SubMenus();$('#encimera_list').show();">ENCIMERA</button>
                    <div id="encimera_list" style="text-align:center;display:none;background:#fff;padding:10px;">

                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Cemento/enc_ekbacken_cemento_oscuro.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Cemento/enc_skararp_efectocemento.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Lisa/enc_ekbacken_grisclaro_mate.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Lisa/enc_ekbacken_hueso_mate.png');">
                            <div style="display:flex;">
                          ...
                          <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Lisa/enc_saljan_aluminio.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Lisa/enc_saljan_blanco_brillo.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Lisa/enc_saljan_blanco_mate.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Lisa/enc_barkaboda_madera_nogal.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Madera/enc_ekbacken_fresno.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Madera/enc_karlby_madera_nogal.png');">
                            <div style="display:flex;">
                         ...
                         <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Madera/enc_pinnarp_madera_nogal.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Madera/enc_saljan_madera_roble.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_ekbacken_marmol_grisoscuro.png');">
                            <div style="display:flex;">
                         ...
                         <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_kasker_piedra_marrongrisaceo.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_kasker_piedra_negropurpurina.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_saljan_piedra_blanco.png');">
                            <div style="display:flex;">
                           ...
                           <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_skararp_beigemate_efectopiedra.png');">
                            <div style="display:flex;">
                         ...
                         <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_skararp_blancomate_efectomarmol.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_skararp_negromate_efectomarmol.png');">
                            <div style="display:flex;">
                        ...
                        <button class="materials_submenu_btn" id="" onclick="setMaterialsImages(2,'CapasCocina/ENCIMERA/Piedra/enc_skararp_negromate_efectopiedra.png');">
                            <div style="display:flex;">
                    ...
                    <button class="btn greenBtn fully " id="paredes" onclick="hideStep4SubMenus();$('#paredes_list').show();">PAREDES</button>
                    <div id="paredes_list"  style="display:none;background:#fff;padding:10px;">
                        
                        <button class="blackBtn" id="pared_lateral_btn" onclick="hideWallsMenus();$('.pared_lateral_list').show();">
                        ...
                        <div class="pared_lateral_list">
                            ...
                            <div  class="options_alicatado_list">
                                <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_blanco_brillo_30x60PARED_PUERTA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BlancoBrillo30x60.png" style="width:90%">
                                        <p>Blanco Brillo</p>
                                        <p>30x60cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_blanco_mate_30x60PARED_PUERTA.png');">
                                ...
                                <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_boat_marfil_30x60PARED_PUERTA.png');">
                                       <img src="ImagenesRevestimientos/ImagenesAlicatado/BoatMarfil30x60.png" style="width:90%">
                                        <p>Blanco Marfil</p>
                                        <p>30x60cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_boat_perla_30x60PARED_PUERTA.png');">
                                 ...
                                 <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_biselado_blanco_mate_10x20PARED_PUERTA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BiseladoBlanco10x20.png" style="width:90%">
                                        <p>Biselado Blanco Mate</p>
                                        <p>10x20cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_biselado_blanco_brillo_10x20PARED_PUERTA.png');">
                                ...
                                <div style="display:flex;">
                                    <button class="wall_options_btn" style="width:50%" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_artisan_blanco_brillo_10x20PARED_PUERTA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/AristanBlancoBrillo10x20.png" style="width:90%">
                                        <p>Aristan Blanco Brillo</p>
                                        <p>10x20cm</p>
                                    </button>
                                    <button class="wall_options_btn" style="width:50%" onclick="setMaterialsImages(3,'CapasCocina/ALICATADO/PARED_PUERTA/rev_biselado_negro_mate_10x20_pared_frontal.png');">
                            ...
                            <div class="options_enlucido_list">
                                ...
                                <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(197, 208, 212);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_gris_azulado_ok_pared_puerta.png');">

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(158, 156, 157);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_gris_oscuro_ok_pared_puerta.png');">

                                    </button>
                                     <button class="color_picker_btn" style="background-color:rgb(255, 255, 255);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_rodapie_blanco_pared_puerta.png');">

                                    </button>
                                </div>
                                 <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(182, 176, 165);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_marron_ok_pared_puerta.png');">

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(231, 211, 197);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_beige_ok_pared_puerta.png');">

                                    </button>
                                     <button class="color_picker_btn" style="background-color:rgb(242, 234, 225);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_beige_claro_ok_pared_puerta.png');">

                                    </button>
                                </div>
                                 <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(103, 137, 126);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_verde_ok_pared_puerta.png');">

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(175, 219, 222);" onclick="setMaterialsImages(3,'CapasCocina/ENLUCIDO/PARED_PUERTA/enlucido_azul_ok_pared_puerta.png');">
                        ...
                        <button class="blackBtn" id="pared_frontal_btn" onclick="hideWallsMenus();$('.pared_frontal_list').show();">
                          PARED FRONTAL
                        </button>
                        <div class="pared_frontal_list">
                            ...
                            <div  class="options_alicatado_list">
                                ...
                                <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_blanco_brillo_30x60_pared_frontal.png');" >
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BlancoBrillo30x60.png" style="width:90%">
                                        <p>Blanco Brillo</p>
                                        <p>30x60cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_blanco_mate_30x60_pared_frontal.png');">
                                         <img src="ImagenesRevestimientos/ImagenesAlicatado/BlancoMate30x60.png" style="width:90%">
                                        <p>Blanco Mate</p>
                                        <p>30x60cm</p>
                                    </button>
                                ...
                                <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_boat_marfil_30x60_pared_frontal.png');">
                                       <img src="ImagenesRevestimientos/ImagenesAlicatado/BoatMarfil30x60.png" style="width:90%">
                                        <p>Blanco Marfil</p>
                                        <p>30x60cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_boat_perla_30x60_pared_frontal.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BoatPerla30x60.png" style="width:90%">
                                        <p>Boat Perla</p>
                                        <p>30x60cm</p>
                                    </button>
                                 ...
                                 <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_biselado_blanco_mate_10x20_pared_frontal.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BiseladoBlanco10x20.png" style="width:90%">
                                        <p>Biselado Blanco Mate</p>
                                        <p>10x20cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_biselado_blanco_brillo_10x20_pared_frontal.png');">
                                       <img src="ImagenesRevestimientos/ImagenesAlicatado/BiseladoBlancoBrillo10x20.png" style="width:90%">
                                        <p>Biselado Blanco Brillo</p>
                                        <p>10x20cm</p>
                                    </button>
                                ...
                                <div style="display:flex;" style="width:50%">
                                    <button class="wall_options_btn" style="width:50%" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_artisan_blanco_brillo_10x20_pared_frontal.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/AristanBlancoBrillo10x20.png" style="width:90%">
                                        <p>Aristan Blanco Brillo</p>
                                        <p>10x20cm</p>
                                    </button>
                                    <button class="wall_options_btn" style="width:50%" onclick="setMaterialsImages(4,'CapasCocina/ALICATADO/PARED_FRONTAL/rev_biselado_negro_mate_10x20_pared_frontal.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BiseladoNegroBrillo10x20.png" style="width:90%">
                                        <p>Biselado Negro Mate</p>
                                        <p>10x20cm</p>
                                    </button>
                            ...
                            <div class="options_enlucido_list">
                                 <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(197, 208, 212);" >

                                    </button>
                                     <button class="color_picker_btn" style="background-color:rgb(158, 156, 157);" >
                                    </button>
                                     <button class="color_picker_btn" style="background-color:rgb(255, 255, 255);" >

                                    </button>
                                </div>
                                 <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(182, 176, 165);">

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(231, 211, 197);">

                                    </button>
                                     <button class="color_picker_btn" style="background-color:rgb(242, 234, 225);" >

                                    </button>
                                </div>
                                 <div style="display:flex;">
                                     <button class="color_picker_btn" style="background-color:rgb(103, 137, 126);" >

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(175, 219, 222);">
                        ...
                        <button class="blackBtn" id="pared_ventana_btn" onclick="hideWallsMenus();$('.pared_ventana_list').show();">
                        ...
                        <div class="pared_ventana_list">
                            ...
                            <div  class="options_alicatado_list">
                                 <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_blanco_brillo_30x60PARED_VENTANA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BlancoBrillo30x60.png" style="width:90%">
                                        <p>Blanco Brillo</p>
                                        <p>30x60cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_blanco_mate_30x60PARED_VENTANA.png');">
                                         <img src="ImagenesRevestimientos/ImagenesAlicatado/BlancoMate30x60.png" style="width:90%">
                                        <p>Blanco Mate</p>
                                        <p>30x60cm</p>
                                    </button>
                                ...
                                <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_boat_marfil_30x60PARED_VENTANA.png');">
                                       <img src="ImagenesRevestimientos/ImagenesAlicatado/BoatMarfil30x60.png" style="width:90%">
                                        <p>Blanco Marfil</p>
                                        <p>30x60cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_boat_perla_30x60PARED_VENTANA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BoatPerla30x60.png" style="width:90%">
                                        <p>Boat Perla</p>
                                        <p>30x60cm</p>
                                    </button>
                                 ...
                                 <div style="display:flex;">
                                    <button class="wall_options_btn" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_biselado_blanco_mate_10x20PARED_VENTANA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BiseladoBlanco10x20.png" style="width:90%">
                                        <p>Biselado Blanco Mate</p>
                                        <p>10x20cm</p>
                                    </button>
                                    <button class="wall_options_btn" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_biselado_blanco_brillo_10x20PARED_VENTANA.png');">
                                       <img src="ImagenesRevestimientos/ImagenesAlicatado/BiseladoBlancoBrillo10x20.png" style="width:90%">
                                        <p>Biselado Blanco Brillo</p>
                                        <p>10x20cm</p>
                                    </button>
                                ...
                                <div style="display:flex;">
                                    <button class="wall_options_btn" style="width:50%" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_artisan_blanco_brillo_10x20PARED_VENTANA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/AristanBlancoBrillo10x20.png" style="width:90%">
                                        <p>Aristan Blanco Brillo</p>
                                        <p>10x20cm</p>
                                    </button>
                                      <button class="wall_options_btn" style="width:50%" onclick="setMaterialsImages(5,'CapasCocina/ALICATADO/PARED_VENTANA/rev_biselado_negro_mate_10x20PARED_VENTANA.png');">
                                        <img src="ImagenesRevestimientos/ImagenesAlicatado/BiseladoNegroBrillo10x20.png" style="width:90%">
                                        <p>Biselado Negro Mate</p>
                                        <p>10x20cm</p>
                                    </button>
                            ...
                            <div class="options_enlucido_list">
                                  <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(197, 208, 212);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_gris_azulado_ok_pared_ventana.png');">

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(158, 156, 157);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_gris_oscuro_ok_pared_ventana.png');">

                                    </button>
                                     <button class="color_picker_btn" style="background-color:rgb(255, 255, 255);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_rodapie_blanco_pared_ventana.png');">

                                    </button>
                                </div>
                                 <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(182, 176, 165);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_marron_ok_pared_ventana.png');">

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(231, 211, 197);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_beige_ok_pared_ventana.png');">

                                    </button>
                                     <button class="color_picker_btn" style="background-color:rgb(242, 234, 225);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_beige_claro_ok_pared_ventana.png');">

                                    </button>
                                </div>
                                 <div style="display:flex;">
                                    <button class="color_picker_btn" style="background-color:rgb(103, 137, 126);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_verde_ok_pared_ventana.png');">

                                    </button>
                                    <button class="color_picker_btn" style="background-color:rgb(175, 219, 222);" onclick="setMaterialsImages(5,'CapasCocina/ENLUCIDO/Pared_Ventana/enlucido_azul_ok_pared_ventana.png');">
                    ...
                    <button class="btn greenBtn fully " id="suelo" onclick="hideStep4SubMenus();$('#suelo_list').show();"">SUELO</button>
                    <div id="suelo_list" style="display:none;background:#fff;padding:10px;">

                        <div style="display:flex;">
                            <button class="wall_options_btn" style="width:30%; margin-left:1.5%;margin-right: 1.5%;">
                               <img src="iconos/enlucido_paredes.jpg">
                                <p>Biselado Blanco Brillo</p>
                                <p>10x20cm</p>
                            </button>
                    ...
                    <button class="btn greenBtn fully " id="door_mode" onclick="hideStep4SubMenus();$('#rodapie_list').show();">RODAPIE</button>
                    <div id="rodapie_list"  style="display:none;background:#fff;padding:10px;">
                        ...
                        <div class="rodapie_pared_puerta_list">
                            ...
                            <div style="display:flex;">
                                <button class="floor_panel_btn">
                                    <img>
                                    <p>Foster Light 8x60cm</p>
                                </button>
                                <button class="floor_panel_btn">
                                     <img>
                                    <p>Pecan Beige 8x60cm</p>
                                </button>
                    ...
                    <button class="btn greenBtn fully " id="door_mode" onclick="hideStep4SubMenus();$('#RYL_list').show();">REJUNTE Y LISTELO</button>
                    <div id="RYL_list" style="display:none;background:#fff;padding:10px;">
                    ...
                    <button class="btn greenBtn fully " id="carpinteria_mode" onclick="hideStep4SubMenus();$('#carpinteria_list').show();">CARPINTERIA</button>
                    <div id="carpinteria_list"   style="display:none;background:#fff;padding:10px;">
                        <button class="blackBtn" id="carpinteria_mode" onclick="hideCarpentryMenus();$('.door_list').show();">PUERTAS</button>
                        <div class="door_list" >
                            <div style="display:flex;">
                                <button class="carpentry_options_btn" style="width:30%; margin-left:1.5%;margin-right: 1.5%;">
                                   <img src="iconos/enlucido_paredes.jpg">
                                    <p>Puerta Blanca</p>
                                </button>
                                <button class="carpentry_options_btn" style="width:30%; margin-left:1.5%;margin-right: 1.5%;">
                        ...
                        <button class="blackBtn " id="carpinteria_mode" onclick="hideCarpentryMenus();$('.window_list').show();">VENTANAS</button>
                         <div class="window_list">
                            <div style="display:grid;grid-template-columns: auto auto;">
                                <button class="carpentry_options_btn">
                                   <img src="iconos/enlucido_paredes.jpg">
                                    <p>Ventana Blanca</p>
	...
	<div id="opciones_equipamiento" >
            ...
            <div style="display:grid; grid-template-columns: auto auto;">
                ...
                <button class="carpentry_options_btn">
                     <img src="iconos/enlucido_paredes.jpg">
                   <p>Termo eléctrico</p>
                   <p>Fleck Duo-5 100L</p>
                </button>
                
            </div>
             <div style="display:grid;
                 grid-template-columns: auto auto auto; width:calc( 100% - 20px ); margin: 10px;">
                <button class="carpentry_options_btn">
                   <img src="iconos/enlucido_paredes.jpg">
                   <p> Radiador Xian</p>
                   <p>700 N 3 elem</p>
  ...
  <script>
	...
	$("#menu_instalaciones").click(function() {
       ...
       $("#menu_equipamiento").click(function() {
        ...
        $(".floor_panel_btn").click(function(){
            $(this).parent().children(".floor_panel_btn").removeClass("active");
            $(this).addClass("active");
        });
        ...
        function setMaterialsImages(container,image){
           const containerArray=["#imagen_frente_armario","#imagen_encimera","#imagen_pared_lateral_puerta","#imagen_pared_frontal","#imagen_pared_lateral_ventana","#imagen_encimera"];
