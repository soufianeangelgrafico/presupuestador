  ...
  if (!boot && localStorage.getItem('history')) localStorage.removeItem('history');
    if (localStorage.getItem('history') && boot == "recovery") {
	 ...
	 if (boot == "newSquare") {
		...
		$("#boxRoom").append('<path d="M897,309 L1232,309 L1232,118 L897,118 L897,309" fill="url(#gradientWhite)" fill-opacity="1" stroke="none" fill-rule="evenodd" class="room"></path>');
