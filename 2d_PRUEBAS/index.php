			  ...
			  <button class="btn greenBtn fully " id="door_mode" onclick="$('.sub').hide();$('#door_list').toggle(200);$('#window_list').hide();">Puertas</button>
                                    <div id="door_list"  class="list-unstyled sub" style="display:none;background:#fff;padding:10px;">
                                        <div style="display:flex">
                                            <div class="btn fully door" id="aperture">
                                                <svg >
                                                    <g fill="white" stroke="black" stroke-width="1" transform="scale(1, 1)">
                                                        <path d="M -30,-5 L -30,5 L 30,5 L 30,-5 Z" stroke-width="1" fill="#ccc" stroke="#494646" stroke-dasharray="5,5"></path>
                                                        <path d="M -30,-5 L -30,5 L -25,5 L -25,-5 Z" stroke-width="1" fill="none" stroke="#494646" stroke-dasharray="none"></path>
                                                        <path d="M 25,-5 L 25,5 L 30,5 L 30,-5 Z" stroke-width="1" fill="none" stroke="#494646" stroke-dasharray="none"></path>
                                                    </g>
                                                </svg>
                                            ...
                                            <button class="btn fully door" id="double">
                                              <g fill="white" stroke="black" stroke-width="1" transform="scale(1, 1)">
                                                    <path d="M -30,-5 L 30,-5 L 30,5 L -30,5 Z" stroke-width="1" fill="white" stroke="black" stroke-dasharray="5,5"></path>
                                                    <path d="M -30,5 L -30,-5 L -25,-5 L -25,5 Z" stroke-width="1" fill="white" stroke="#494646" stroke-dasharray="none"></path>
                                                    <path d="M 30,5 L 30,-5 L 25,-5 L 25,5 Z" stroke-width="1" fill="white" stroke="#494646" stroke-dasharray="none"></path>
                                                    <path d="M -25,5 L -25,30 L -20,30 L -20,5" stroke-width="1" fill="black" stroke="#666" stroke-dasharray=""></path>
                                                    <path d="M -20,30  Q0,20,0,5, Z" stroke-width="1" fill="none" stroke="#666" stroke-dasharray=""></path>
                                                    <path d="M 25,5 L 25,30 L 20,30 L 20,5" stroke-width="1" fill="black" stroke="#666" stroke-dasharray=""></path>
                                                    <path d="M 20,30  Q0,20,0,5, Z" stroke-width="1" fill="none" stroke="#666" stroke-dasharray=""></path>
                                                </g>
                                            </button>
						   ...
						   for ($i=0;$i<count($paredes_totales_array);$i++)
						   {
							 if ($paredes_totales_array[$i] != "")
							 {
								 if (strstr($paredes, $paredes_totales_array[$i]))
								 {
									 ...
									 $result_longitud=$mysqli->query("SELECT longitud_pared_reformado FROM clientes WHERE id_presupuesto=".$_GET['id_presupuesto']." AND longitud_pared_reformado != 0 LIMIT 1");
