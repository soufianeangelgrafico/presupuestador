...
?>
	<script>
		...
		// window.location.assign("https://rehubik.com/presupuestador/2d v0.0.1/previa.php");
	...
	?>
		<div id="parte_superior">
			<div id="header">
				...
				<button class="btn screenshot fully" id="screenshot" onclick="">Cambiar de estado</button>
			</div>
			...
			<div id="menu_planificador">
				...
				<div class="nextBtn" id="btnFinalizar"><span>Finalizar</span></div>
			</div>
										...
										<form class="form_muros" name="<?php echo $arr_result['id_imagen']; ?>" method="POST" action="#">
											...
											?>
														<span class="checkmuro">
															...
															<input type='range' value='0.1' min='0.1' name='metros_parcial' class='<?php echo $id; //echo $valor_pared; ?>' max='<?php echo $metros_pared[2]; ?>' step='0.01' oninput='this.nextElementSibling.value = this.value'>
	...
	<div id="bloque_estado_actual" style="background: #95C11F; display: none;">
		<div id="imagen_bloque_estado_actual">
			...
			<?php 
				...
				// } 
			?>
			<!-- <img src="<?php //echo $png_estado_actual; ?>" width="100%" height=""> -->
		</div>
	</div>
			...
			if (altura_techo != "") {
				...
				if (!entro)
					...
					$.ajax({
						...
						dataType: 'json',
						async: false,
						url: "ajax/guardar_sc_presupuesto.php?id_presupuesto=<?php
																				if (isset($_GET['id_presupuesto'])) {
																					echo $_GET['id_presupuesto'];
																				} else {
																					echo "0";
																				}
																				?>",
