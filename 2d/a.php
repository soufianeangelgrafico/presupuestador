...
<body style="background:#d6d6d6;margin:0;padding:0; ">
  ...
  <div id="observaciones_plano">
    ...
    <div id="contenido_observaciones_plano" style="padding: 5px;height: 300px;max-width: 100%;">
      Escribe tus anotaciones<br><textarea id="textarea_observaciones" class="form-control" style="resize: none; width: 100%;height: 200px;max-height: 100%;" resize="off"><?php echo $obj_estado_actual->observaciones_dibujo_actual;?>&#13;&#10;ESTADO REFORMADO:&#13;&#10;</textarea>
    </div>
  </div>
	...
	<div id="opciones_equipamiento" >
					   ...
					   <img src="CapasCocina/EQUIPAMIENTO/TermoFleckDuo-5EU.png"/>
						<div style="width:97.5%; margin-left:2.5%">
							...
							<div  class="dropdown-content">
								...
								<button id="PLA00106438" class="equipamiento" onclick="manageStep5Submenu(this,0);">80 Litros</button>
								<button id="PLA00107800" class="equipamiento" onclick="manageStep5Submenu(this,0);">100 Litros</button>
							 </div>
				  ...
				  <div class="dropdown_thermus" >
					   <img src="CapasCocina/EQUIPAMIENTO/ThermorConcept.png"/>
						<div style="width:90%; margin-left:10%">
							...
							<div  class="dropdown-content">
								<p>Selecciona capacidad</p>
								<button id="PLA00146116" class="equipamiento" onclick="manageStep5Submenu(this,0);">30 Litros</button>
								<button id="PLA00146114" class="equipamiento" onclick="manageStep5Submenu(this,0);">50 Litros</button>
								<button id="PLA00146111" class="equipamiento" onclick="manageStep5Submenu(this,0);">80 Litros</button>
								<button id="PLA00146112" class="equipamiento" onclick="manageStep5Submenu(this,0);">100 Litros</button>
							 </div>
					   ...
					   <img src="CapasCocina/EQUIPAMIENTO/CeresAltech.png"/>
						<div style="width:97.5%; margin-left:2.5%">
							...
							<div  class="dropdown-content">
								...
								<button id="PLA00405804" class="equipamiento" onclick="manageStep5Submenu(this,0);">50 Litros</button>
								<button id="PLA00405805" class="equipamiento" onclick="manageStep5Submenu(this,0);">80 Litros</button>
								<button id="PLA00405807" class="equipamiento" onclick="manageStep5Submenu(this,0);">100 Litros</button>
							 </div>
			 ...
			 <div class="child_list">
				<div class="calentadoresList" style="/* display:grid; *//* grid-template-columns: auto auto; */width: 80%;margin: 0px auto;">
					...
					<button id="PLA00370460" class="equipamiento" onclick="manageStep5Submenu(this,1);" class="equipment_options_btn">
					...
					<button id="PLA00370462" class="equipamiento" onclick="manageStep5Submenu(this,1);" class="equipment_options_btn">
					   <img src="CapasCocina/EQUIPAMIENTO/CalentadorHydronext.png" style="width:80%"/>
						<p>Calentador Gas Natural Hydronext 5600S WTD 15-3 AME23</p>
					

					</button>
					<button id="PLA00370463" class="equipamiento" onclick="manageStep5Submenu(this,1);" class="equipment_options_btn">
						<img src="CapasCocina/EQUIPAMIENTO/CalentadorHydronext.png" style="width:80%"/>
			...
			<div class="child_list">
				 <div class="calderasList" style="/*display:grid;
					...
					<button id="PLA00162142" class="equipamiento" onclick="manageStep5Submenu(this,1);" class="equipment_options_btn">
					...
					<button id="PLA00390526" class="equipamiento" onclick="manageStep5Submenu(this,1);" class="equipment_options_btn">
					...
					<button id="PLA01914858" class="equipamiento" onclick="manageStep5Submenu(this,1);" class="equipment_options_btn">
			...
			<div class="child_list" style="grid-template-columns: auto; width:calc( 100% - 20px ); margin: 10px;">
                            ...
                            <div class="dropdown_radiator">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <button class="equipamiento" id="PLA00113104" onclick="selectRadiator(this,0);">450 N</button>
                                    <button class="equipamiento" id="PLA00113106" onclick="selectRadiator(this,1);">600 N</button>
                                    <!--<button onclick="selectRadiator(this,2);">700 N</button>-->
                                    <button class="equipamiento" id="PLA00113120" onclick="selectRadiator(this,2);">800 N</button>
		 ...
		 if (altura_techo != "")
		 {
		   $(".elemento_instalacion.selected").each(function() {
			 ...
			 $.ajax({
				 ...
				 dataType: 'json', 
				 async:false,
				 url: "ajax/finalizar_plano.php",
				 data: formulario + "&dibujo="+dibujo+"&observaciones="+observaciones_texto+"&altura_techo="+altura_techo+"&total_muros="+total_muros+"&metros_cuadrados="+metros_cuadrados,
				 success:function(respuesta){	
					 alertify.success(respuesta.mensaje);
				 }
