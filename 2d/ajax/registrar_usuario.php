...
$result_datos_plano_pdf=$mysqli->query("SELECT imagen_dibujo_actual, observaciones FROM planos WHERE id=$idplano");
...
$codigoHTML.='<div class="cabecera_reforma">
...
<div class="contenedor_cocina"> 
 ...
 <div class="fotografia_cocina"> 
	<img src="https://rehubik.com/presupuestador/2d/CapasCocina/general_post.jpg" style="width:100%">
 </div>
</div>
...
if ($result_revestimientos->num_rows)
{
	...
	while ($arr_result_revestimientos = $result_revestimientos->fetch_array())
	{
		...
		$codigoHTML.='<tr><td>
		<p>
			<img src="'.$foto_revestimiento.'" style="width:250px;height:250px;">
			</p>
		</td>
		<td> 
			<p> 
...
$codigoHTML.='<div class="foto_plano">
				<img src="'.$obj_datos_plano->imagen_dibujo_actual.'" style="width:800px;">
			  </div>';
...
if ($result->num_rows)
{
  ...
  $codigoHTML.='<table class="table" style="font-size:12px; margin-top:25px;">
				  <thead>
					<tr>
...
$codigoHTML.='<img src="https://rehubik.com/presupuestador/2d/contraportada.png" style="width:1000px">';
