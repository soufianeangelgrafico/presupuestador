...
?>
   <script>
	   ...
	   window.location.assign("https://rehubik.com/presupuestador/2d/previa.php");
   </script>
<?php
}
...
<body 
 style="background:#d6d6d6;margin:0;padding:0;" 
 <?php if (isset($_GET["id_presupuesto"])) { ?> 
	id="<?php echo $_GET['id_presupuesto'];?>"
	<?php } else { ?>id="0" <?php } ?>>

  <div id="observaciones_plano">
    <div id="titulo_observaciones_plano">OBSERVACIONES</div>
...
?>	 
 <div id="parte_superior">
	...
	<div id="menu_planificador_movil">
	 <!-- onclick="window.open('https://rehubik.com/presupuestador/2d/ver_plano_estado_actual.php?sesion=< ?php echo $_COOKIE['random'];?>','Estado actual','menubar=1,resizable=1,width=380,height=400')" -->
		    ...
		    <div id="informacion_panel">
				<div id="listado_muros"></div>
				  ...
				  <div id="wallTools" style="display:none;">
					...
					<button class="btn btn-info" onclick="fonc_button('select_mode');$('#boxinfo').html('Modo selección');$('#wallTools').hide('300');$('#panel').show('300');hideAllSize();rib();"><i class="fa fa-2x fa-backward" aria-hidden="true" ></i></button></li>
					</ul>
                        ...
                        <button class="blackBtn" id="pared_ventana_btn" onclick="hideRYLMenus();$('.listelos_list').show();">
                          ...
                          <div class="listelos_list" style="display:none;background:#fff;padding:10px;">
                                <button class="flexBtn" >
									...
									<div class="unidades_elemento" style="display: none;">
									 <form class="form_unidades" name="listelos" method="POST" action="#">
									  <input type="text" name="elemento" style="display:none" value="listelo_aluminio_plata_mate">
                               ...
                               <button class="flexBtn" >
								    ...
								    <div class="unidades_elemento" style="display: none;">
									 <form class="form_unidades" name="listelos" method="POST" action="#">
									  <input type="text" name="elemento" style="display:none" value="listelo_aluminio_plata_brillo">
									  <input type="range" value="1" min="1" max="30" step="1" oninput="this.nextElementSibling.value = this.value" class="numero_listados" name="unidades">
									  Unidades: <output style="display:inline-block"></output> 	 
									 </form>	 
								   </div>
                               ...
                               <button class="flexBtn" >
                                    <img src="CapasCocina/REJUNTES/Listelo_aluminio_lacado_en_blanco_12x12mm2_6m.png" />
								     ...
								     <div class="unidades_elemento" style="display: none;">
									 <form class="form_unidades" name="listelos" method="POST" action="#">
									  <input type="text" name="elemento" style="display:none" value="listelo_aluminio_lacado">
									  <input type="range" value="1" min="1" max="30" step="1" oninput="this.nextElementSibling.value = this.value" class="numero_listados" name="unidades">
									  Unidades: <output style="display:inline-block"></output> 	 
									 </form>	 
								   </div>
					 ...
					 ?>
						<div class="metros_lineales" <?php if (isset($_GET["id_presupuesto"])) {?> style="display:block;" <?php } ?>>
						 <form class="form_metros" name="<?php echo $arr_result['id_imagen'];?>" method="POST" action="#">
						  <input type="text" name="elemento" style="display:none" value="<?php echo $arr_result['id_imagen'];?>">
						  <input type="range" value="<?php if (isset($metros_lineales) && $metros_lineales != 0) { echo $metros_lineales; } else { ?> 1 <?php } ?>" min="1" max="30" step="0.1" oninput="this.nextElementSibling.value = this.value" class="form-control" name="metros_lineales">
						  Metros lineales: <output style="display:inline-block"><?php if (isset($metros_lineales) && $metros_lineales != 0) { echo $metros_lineales; } else { ?> 1 <?php } ?></output> 
	...
	<div id="opciones_equipamiento" >
			 ...
			 <div class="child_list">
				<div class="thermusList" style="display:grid; grid-template-columns: auto;">
					<div class="dropdown_thermus" >
					   <img 
					   src="CapasCocina/EQUIPAMIENTO/TermoFleckDuo-5EU.png"
					   <?php if (in_array("PLA00106438",$referencia_material) || in_array("PLA00107800",$referencia_material) ) { ?> 
						class="active" 
						<?php } ?>
					   />
						<div style="width:97.5%; margin-left:2.5%">
							...
							<div  class="dropdown-content">
								...
								<button id="PLA00106438" 
								 class="equipamiento <?php if (in_array("PLA00106438",$referencia_material)) { ?>active <?php } ?>" 
								 onclick="manageStep5Submenu(this,0);">80 Litros</button>
								<button id="PLA00107800" 
								 class="equipamiento <?php if (in_array("PLA00107800",$referencia_material)) { ?>active <?php } ?>" 
								 onclick="manageStep5Submenu(this,0);">100 Litros</button>
				  ...
				  <div class="dropdown_thermus" >
					   <img 
					   src="CapasCocina/EQUIPAMIENTO/ThermorConcept.png"
					   <?php if (in_array("PLA00146116",$referencia_material) || in_array("PLA00146114",$referencia_material) || in_array("PLA00146111",$referencia_material) || in_array("PLA00146112",$referencia_material)) { ?>
						class="active" 
						<?php } ?>
					   />
						<div style="width:90%; margin-left:10%">
							...
							<div  class="dropdown-content">
								<p>Selecciona capacidad</p>
								<button id="PLA00146116" 
								class="equipamiento <?php if (in_array("PLA00146116",$referencia_material)) { ?>active <?php } ?>" 
								onclick="manageStep5Submenu(this,0);">30 Litros</button>
								<button id="PLA00146114" 
								class="equipamiento <?php if (in_array("PLA00146114",$referencia_material)) { ?>active <?php } ?>" 
								onclick="manageStep5Submenu(this,0);">50 Litros</button>
								<button id="PLA00146111" 
								class="equipamiento <?php if (in_array("PLA00146111",$referencia_material)) { ?>active <?php } ?>" 
								onclick="manageStep5Submenu(this,0);">80 Litros</button>
								<button id="PLA00146112" 
								class="equipamiento <?php if (in_array("PLA00146112",$referencia_material)) { ?>active <?php } ?>" 
								onclick="manageStep5Submenu(this,0);">100 Litros</button>
							 </div>
					 ...
					 <div class="dropdown_thermus" >
					   <img 
					   src="CapasCocina/EQUIPAMIENTO/CeresAltech.png"
					   <?php if (in_array("PLA00405804",$referencia_material) || in_array("PLA00405805",$referencia_material) || in_array("PLA00405807",$referencia_material)) { ?>
						class="active" 
						<?php } ?>
						/>
						<div style="width:97.5%; margin-left:2.5%">
							...
							<div  class="dropdown-content">
								...
								<button id="PLA00405804" 
								class="equipamiento <?php if (in_array("PLA00405804",$referencia_material)) { ?>active <?php } ?>" 
								onclick="manageStep5Submenu(this,0);">50 Litros</button>
								<button id="PLA00405805"
								class="equipamiento <?php if (in_array("PLA00405805",$referencia_material)) { ?>active <?php } ?>" 
								onclick="manageStep5Submenu(this,0);">80 Litros</button>
								<button id="PLA00405807" 
								class="equipamiento <?php if (in_array("PLA00405807",$referencia_material)) { ?>active <?php } ?>" 
								onclick="manageStep5Submenu(this,0);">100 Litros</button>
							 </div>
			 ...
			 <div class="child_list">
				<div class="calentadoresList" style="/* display:grid; *//* grid-template-columns: auto auto; */width: 80%;margin: 0px auto;">
					...
					id="PLA00370460" 
					class="equipamiento" 
					onclick="manageStep5Submenu(this,1);" 
					class="equipment_options_btn <?php if (in_array("PLA00370460",$referencia_material)) { ?>active <?php } ?>">
					...
					class="equipamiento" 
					onclick="manageStep5Submenu(this,1);" 
					class="equipment_options_btn <?php if (in_array("PLA00370462",$referencia_material)) { ?>active <?php } ?>">
					   <img src="CapasCocina/EQUIPAMIENTO/CalentadorHydronext.png" style="width:80%"/>
					...
					class="equipamiento" 
					onclick="manageStep5Submenu(this,1);" 
					class="equipment_options_btn <?php if (in_array("PLA00370463",$referencia_material)) { ?>active <?php } ?>">
						<img src="CapasCocina/EQUIPAMIENTO/CalentadorHydronext.png" style="width:80%"/>
			...
			<div class="child_list">
				 <div class="calderasList" style="/*display:grid;
					 grid-template-columns: auto auto; width:calc( 100% - 20px ); margin: 10px;*/ width:80%;margin:0px auto;">
					<button id="PLA00162142" 
					class="equipamiento" 
					onclick="manageStep5Submenu(this,1);" 
					class="equipment_options_btn <?php if (in_array("PLA00162142",$referencia_material)) { ?>active <?php } ?>">
					...
					class="equipamiento" 
					onclick="manageStep5Submenu(this,1);" 
					class="equipment_options_btn <?php if (in_array("PLA00390526",$referencia_material)) { ?>active <?php } ?>">
					...
					class="equipamiento" 
					onclick="manageStep5Submenu(this,1);" 
					class="equipment_options_btn <?php if (in_array("PLA01914858",$referencia_material)) { ?>active <?php } ?>">
...
?>
   ...
   <div id="titulo_estado_actual">
	...
	<div id="botones-zoom">
	 ...
	 <div id="bloque_estado_actual" style="background: #95C11F;">
	   <div id="imagen_bloque_estado_actual"><img src="<?php echo $png_estado_actual;?>" width="600" height="250"></div>
     </div> 
  ...
  <div id="zoomBox" style="position:absolute;z-index:100;right:-150px;bottom:30px;text-align:center;background:transparent;padding:0px;color:#fff;transition-duration: 0.2s;transition-timing-function: ease-in;">
	...
	$("#menu_instalaciones").click(function() {
       ...
       $("#menu_equipamiento").click(function() {
        ...
        $(".style-options").click(function() {
			...
			if (id_material == "nordicoStyleBtn")
				var estilo="estilo1";
			else if (id_material == "minimalistaStyleBtn")
			    var estilo="estilo2";
			else if (id_material == "industrialStyleBtn")
				var estilo="estilo3";
			else if (id_material == "rusticoStyleBtn")
				var estilo="estilo4";
			else if (id_material == "clasicoStyleBtn")
				var estilo="estilo5";
			else if (id_material == "mediterraneoStyleBtn")
				var estilo="estilo6";
			else
				var estilo="libre";
			...
			$(".wall_options_btn").each(function () {
				...
				if ($(this).hasClass(estilo) || $(this).hasClass("alicatadoBtn") || $(this).hasClass("enlucidoBtn"))
					$(this).show();
