 ...
 <div id="parte_superior">
	 <div id="header">
		 ...
		 <?php
		  ...
		  {
		 ?>
		 <div id="btnSave"><span>Siguiente paso</span></div>
		 <?php
		  }
		 ?>
	 </div>
...
<script>
  ...
  $( document ).ready(function() {
	 ...
	 $("#altura_techo_actual").change(function() {
		...
		$("#boxText").html('<g transform="translate(1585,58) rotate(0,0,0) scale(1, 1)" id="txt_altura_techo"><text x="0" y="0" font-size="15px" stroke="rgb(51, 51, 51)" stroke-width="0px" font-family="roboto" text-anchor="middle" fill="rgb(51, 51, 51)">H: '+this.value+'m</text></g>');
	 ...
	 $("#btnSiguientePaso").click(function() {
		 ...
		 if (numero_muros > 0)
		 {
			 ...
			 $.ajax({
					 ...
					 data: {contenido:contenido,elementos_dibujados:elementos_dibujados,puertas_ventanas:puertas_ventanas,observaciones:observaciones},
